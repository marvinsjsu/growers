...
<html lang="en">
    ...
    <div id="page-wrapper">
        ...
        <header id="header" class="alt">
            <h1 id="logo"><a href="index.html">GrownBy <span> - Let's get cultivated</span></a></h1>
            <nav id="nav">
                <ul>
        ...
        <article id="main">
            ...
            <section class="wrapper style3 container special">
                ...
                <header class="major">
                    <h2><!--[-->Growing is a<!--]--> <strong><!--[-->learning experience<!--]--></strong></h2>
                </header>
                ...
                <div class="row">
                    <div class="6u 12u(narrower)">
                        ...
                        <section>
                            <a href="#" class="image featured"><img src="/img/growers_bg.jpg" alt="" /></a>
                            <header>
                                <h3><!--[-->Marijuana Horticulture<!--]--></h3>
                            </header>
                            <p class="left">Sed tristique purus vitae volutpat commodo suscipit amet sed nibh. Proin a ullamcorper sed blandit. Sed tristique purus vitae volutpat commodo suscipit ullamcorper sed blandit lorem ipsum dolore.</p>
                        </section>
